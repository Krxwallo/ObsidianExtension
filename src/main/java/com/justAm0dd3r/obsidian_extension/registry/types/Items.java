    ...
    static {
        if (Config.COMMON.enableArmor.get()) {
            OBSIDIAN_CHESTPLATE = ITEMS.register("obsidian_chestplate", () -> new ObsidianArmorItem(
                    ArmorMaterials.OBSIDIAN_ARMOR_MATERIAL, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroups.getFromBlock(OBSIDIAN))));
            OBSIDIAN_HELMET = ITEMS.register("obsidian_helmet", () -> new ObsidianArmorItem(
                    ArmorMaterials.OBSIDIAN_ARMOR_MATERIAL, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroups.getFromBlock(OBSIDIAN))));
            OBSIDIAN_LEGGINGS = ITEMS.register("obsidian_leggings", () -> new ObsidianArmorItem(
                    ArmorMaterials.OBSIDIAN_ARMOR_MATERIAL, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroups.getFromBlock(OBSIDIAN))));
            OBSIDIAN_BOOTS = ITEMS.register("obsidian_boots", () -> new ObsidianArmorItem(
                    ArmorMaterials.OBSIDIAN_ARMOR_MATERIAL, EquipmentSlotType.FEET, new Item.Properties().group(ItemGroups.getFromBlock(OBSIDIAN))));
